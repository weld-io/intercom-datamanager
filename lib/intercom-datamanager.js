...
// Intercom: Users
const updateIntercomUsers = function (usersArray) {
...
// Intercom: Tags
const updateIntercomTags = function (tagArray) {
...
const generateCompanyIdFromName = function (companyName) {
...
const mapColumnArrayToObjectArray = function (userArray) {
  var resultArray = []
  var fieldNamesArray = []
...
const doInChunks = function (array, limit, callback) {
  var chunk = []
  for (var i in array) {
    chunk.push(array[i])
